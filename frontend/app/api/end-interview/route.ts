...
CRITICAL: Your score, decision, and notes MUST be fully consistent. If you score 50 or below, the decision must be Weak or Reject. There must be ZERO contradiction between the numeric score and the written assessment.
...
- For technicalAssessment: set to null since this is a personality round, not technical.`;
    ...
    if (analysis.score > 50 && analysis.decision !== 'Reject') {
