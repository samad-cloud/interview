              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding:8px 0 28px;">
                    <!--[if mso]>
                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${round2Link}" style="height:52px;v-text-anchor:middle;width:280px;" arcsize="15%" strokecolor="#a00250" fillcolor="#c30361">
                    <w:anchorlock/>
                    ...
                    <![endif]-->
                    <!--[if !mso]><!-->
                    <a href="${round2Link}" target="_blank" style="display:inline-block; background-color:#c30361; color:#ffffff; text-decoration:none; font-size:16px; font-weight:700; padding:16px 40px; border-radius:8px; line-height:1; letter-spacing:0.3px; border-bottom:3px solid #a00250;">
